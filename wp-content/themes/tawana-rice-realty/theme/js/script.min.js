(() => {
  ...
  !function() {
    const e = (e2, t2) => {
      let s2 = false;
      return () => {
        s2 || (e2(), s2 = true, setTimeout(() => s2 = false, t2));
      };
    }, t = (e2) => {
      e2.className !== e2.dataset.taosClass && (e2.className = e2.dataset.taosClass);
    }, s = (e2) => e2.className = e2.className.replaceAll("taos:", ""), a = (e2) => (e2.className.includes("taos-init") || (e2.dataset.taosClass = e2.className + " taos-init", t(e2)), e2.className += " !duration-[0ms] !delay-[0ms]", s(e2), { element: e2, once: "1" === getComputedStyle(e2)["animation-iteration-count"], offset: parseInt(e2.dataset.taosOffset || 0) });
    let n = [], i = window.innerWidth, o = window.scrollY;
    const l = e(() => {
      n.forEach((e2) => e2.trigger = e2.element.getBoundingClientRect().top - window.innerHeight + e2.offset + o);
    }, 250), r = () => {
      n = [], document.querySelectorAll('[class*="taos"]').forEach((e2) => n.push(a(e2))), l(), requestAnimationFrame(c);
    }, c = () => {
      o = window.scrollY, n.forEach(({ element: e2, trigger: a2, once: n2 }) => {
        a2 < o ? t(e2) : !n2 && e2.className.includes("taos:") && s(e2);
      }), l();
    };
    r(), addEventListener("scroll", e(c, 32)), addEventListener("orientationchange", r), addEventListener("resize", /* @__PURE__ */ ((e2, t2) => {
      let s2 = null;
      return () => {
        clearTimeout(s2), s2 = setTimeout(e2, t2);
      };
    })(() => {
      i !== window.innerWidth && (i = window.innerWidth, r());
    }, 250)), new MutationObserver((e2) => {
      e2.forEach(({ target: e3 }) => {
        e3.className && !e3.className.includes("taos-init") && e3.className.includes("taos:") && n.push(a(e3));
      });
      ...
      this._handlers = {
        "initialized.owl.carousel change.owl.carousel resized.owl.carousel": $.proxy(function(e) {
          ...
          if (e.property && e.property.name == "position" || e.type == "initialized") {
            var settings = this._core.settings, n = settings.center && Math.ceil(settings.items / 2) || settings.items, i = settings.center && n * -1 || 0, position = (e.property && e.property.value !== undefined2 ? e.property.value : this._core.current()) + i, clones = this._core.clones().length, load = $.proxy(function(i2, v) {
              this.load(v);
            }, this);
  ...
  (0, import_jquery.default)(document).ready(function($) {
    var owlCarousel = $(".hero.owl-carousel");
        ...
        navText: [
          `<span class="icon-arrow-left cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="23" viewBox="0 0 64 23" fill="none">
                        <path d="M63.5 11.5L3.5 11.5" stroke="white" stroke-width="4"/>
                        <path d="M13.5 21.5L3.5 11.5L13.5 1.5" stroke="white" stroke-width="4"/>
                    </svg>
                </span>`,
          `<span class="icon-arrow-right cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="23" viewBox="0 0 64 23" fill="none">
                        <path d="M0.5 11.4999L60.5 11.5" stroke="white" stroke-width="4"/>
                        <path d="M50.5 1.5L60.5 11.5L50.5 21.5" stroke="white" stroke-width="4"/>
                    </svg>
                </span>`
        ],
        dots: false,
    ...
    (0, import_jquery.default)('<div id="counterhero" class="slider-counter text-white"></div>').insertBefore(".hero.owl-carousel .owl-next");
    function updateCounter(carousel) {
      var currentIndex = carousel.relative(carousel.current()) + 1;
      var totalItems = carousel.items().length;
      (0, import_jquery.default)("#counterhero").text(`${currentIndex}/${totalItems}`);
    }
    owlCarousel.on("initialized.owl.carousel", function(e) {
      if (!e.namespace) return;
      updateCounter(e.relatedTarget);
    });
    owlCarousel.on("changed.owl.carousel", function(e) {
      if (!e.namespace) return;
      updateCounter(e.relatedTarget);
    });
    var initialCarousel = owlCarousel.data("owl.carousel");
    if (initialCarousel) {
      updateCounter(initialCarousel);
    }
  });
  (0, import_jquery.default)(document).ready(function($) {
    var owlCarousel = $(".sold.owl-carousel");
    if (owlCarousel.length) {
      owlCarousel.owlCarousel({
        items: 1,
        loop: true,
        ...
        navText: [
          `<span class="icon-arrow-left cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="107" height="36" viewBox="0 0 107 36" fill="none">
                        <path d="M107 18L3 18" stroke="#E65186" stroke-width="4"/>
                        <path d="M20.3336 34L3.00025 18L20.3336 2" stroke="#E65186" stroke-width="4"/>
                    </svg>
                </span>`,
          `<span class="icon-arrow-right cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="107" height="36" viewBox="0 0 107 36" fill="none">
                        <path d="M0 18L104 18" stroke="#E65186" stroke-width="4"/>
                        <path d="M86.6664 2L104 18L86.6664 34" stroke="#E65186" stroke-width="4"/>
                    </svg>
                </span>`
        ],
        dots: false,
  ...
  (0, import_jquery.default)(document).ready(function() {
    var owl = (0, import_jquery.default)(".gallery.owl-carousel").owlCarousel({
      loop: true,
      ...
      animateIn: "fadeIn",
      navText: [
        '<svg xmlns="http://www.w3.org/2000/svg" width="42" height="18" viewBox="0 0 42 18" fill="none"><path d="M42 9L2 8.99999" stroke="white" stroke-width="2"/><path d="M10 17L2 9L10 1" stroke="white" stroke-width="2"/></svg>',
        '<svg xmlns="http://www.w3.org/2000/svg" width="42" height="18" viewBox="0 0 42 18" fill="none"><path d="M0 9L40 9" stroke="white" stroke-width="2"/><path d="M32 1L40 9L32 17" stroke="white" stroke-width="2"/></svg>'
      ]
    });
    (0, import_jquery.default)('<div id="counter" class="slider-counter"></div>').insertBefore(".gallery.owl-carousel .owl-next");
    function updateCounter(carousel) {
      var currentIndex = carousel.relative(carousel.current()) + 1;
      var totalItems = carousel.items().length;
      (0, import_jquery.default)("#counter").text(`${currentIndex}/${totalItems}`);
    }
    ...
    var initialCarousel = owl.data("owl.carousel");
    if (initialCarousel) {
      updateCounter(initialCarousel);
    }
  });
  (0, import_jquery.default)(document).ready(function() {
    var testimonialsOwl = (0, import_jquery.default)(".testimonials.owl-carousel").owlCarousel({
      loop: true,
      responsiveClass: true,
      nav: true,
      dots: false,
      ...
      mouseDrag: true,
      navText: [
        '<svg xmlns="http://www.w3.org/2000/svg" width="42" height="18" viewBox="0 0 42 18" fill="none"><path d="M42 9L2 8.99999" stroke="#E65186" stroke-width="2"/><path d="M10 17L2 9L10 1" stroke="#E65186" stroke-width="2"/></svg>',
        '<svg xmlns="http://www.w3.org/2000/svg" width="42" height="18" viewBox="0 0 42 18" fill="none"><path d="M0 9L40 9" stroke="#E65186" stroke-width="2"/><path d="M32 1L40 9L32 17" stroke="#E65186" stroke-width="2"/></svg>'
      ]
    });
    (0, import_jquery.default)('<div id="testimonials-counter" class="slider-counter text-primary text-[20px]"></div>').insertBefore(".testimonials.owl-carousel .owl-next");
    function updateTestimonialsCounter(carousel) {
      var currentIndex = carousel.relative(carousel.current()) + 1;
      var totalItems = carousel.items().length;
      (0, import_jquery.default)("#testimonials-counter").text(`${currentIndex}/${totalItems}`);
    }
    testimonialsOwl.on("initialized.owl.carousel", function(e) {
      if (!e.namespace) return;
      updateTestimonialsCounter(e.relatedTarget);
    });
    testimonialsOwl.on("changed.owl.carousel", function(e) {
      if (!e.namespace) return;
      updateTestimonialsCounter(e.relatedTarget);
    });
    var initialCarousel = testimonialsOwl.data("owl.carousel");
    if (initialCarousel) {
      updateTestimonialsCounter(initialCarousel);
    }
  });
  ...
  (0, import_jquery.default)(window).on("load", function() {
    var $preloader = (0, import_jquery.default)("#page-preloader"), $spinner = $preloader.find(".spinner");
    $spinner.fadeOut();
